...
class ThreadTestCase(TestCase):
    ...
    def test_add_messages_to_thread(self):
        self.thread.users.add(self.user1, self.user2)
        message_1 = Message.objects.create(user=self.user1, content="Muy buenas")
        message_2 = Message.objects.create(user=self.user2, content="Hola!")
    ...
    def test_add_message_from_user_not_in_thread(self):
        ...
        message_1 = Message.objects.create(user=self.user1, content="Muy buenas")
        message_2 = Message.objects.create(user=self.user2, content="Hola!")
        message_3 = Message.objects.create(user=self.user3, content="Soy un espia")
